...
var Zepto = (function() {
    ...
    return (
        ...
        (B.fragment = function(b, d, e) {
            var g, i, j;
            return (
                m.test(b) && (g = c(h.createElement(RegExp.$1))),
                g ||
        ...
        (c.fn = {
            ...
            position: function() {
                ...
                return (
                    ...
                    (e.left += parseFloat(c(b[0]).css("border-left-width")) || 0), { top: d.top - e.top, left: d.left - e.left }
                );
            },
...
window.$ === undefined && (window.$ = Zepto),
    (function(a) {
        ...
        function s(b, c, e, f, g, i, j) {
            ...
            c.split(/\s/).forEach(function(c) {
                ...
                (h.i = n.length),
                n.push(h),
                    "addEventListener" in b && b.addEventListener(r(h.e), h.proxy, q(h, j));
            });
        }
            ...
            return (
                ...
                m.each(function(d, f) {
                    j &&
                        ...
                        (l = function(b) {
                            var d,
                                g = a(b.target).closest(c, f).get(0);
                            if (g && g !== f) return (d = a.extend(z(b), { currentTarget: g, liveFired: f })), (k || i).apply(g, [d].concat(e.call(arguments, 1)));
                        }),
                        s(f, b, i, h, c, l || k);
                })
            );
        ...
        (a.fn.trigger = function(b, c) {
            return (
                (b = g(b) || a.isPlainObject(b) ? a.Event(b) : y(b)),
                (b._args = c),
                this.each(function() {
        ...
        (a.fn.triggerHandler = function(b, c) {
            ...
            return (
                this.each(function(f, h) {
                    ...
                    (d._args = c),
                    (d.target = h),
                    a.each(n(h, b.type || b), function(a, b) {
                        e = b.proxy(d);
    ...
    (function($) {
        ...
        ($.ajaxJSONP = function(a, b) {
            if ("type" in a) {
                ...
                return (
                    ...
                    ajaxBeforeSend(i, a) === !1 ?
                    (h("abort"), i) :
                    ((window[d] = function() {
                            g = arguments;
                        }),
                        (e.src = a.url.replace(/=\?/, "=" + d)),
        ...
        ($.ajaxSettings = {
            ...
            accepts: { script: "text/javascript, application/javascript, application/x-javascript", json: jsonType, xml: "application/xml, text/xml", html: htmlType, text: "text/plain" },
            crossDomain: !1,
            timeout: 0,
            processData: !0,
            cache: !0,
